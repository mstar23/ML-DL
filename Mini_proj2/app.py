...
if options == '01. Home':
    ...
    #    st.image("https://static.streamlit.io/examples/dog.jpg", width=200)
       ...
       r1_col.image('https://github.com/mstar23/ML-DL/blob/main/Mini_proj2/img/first_pred.png?raw=true',caption='초기 파라미터 값 그래프')
    #    plt.figure(figsize=(5,5))
       r2_col.image('https://github.com/mstar23/ML-DL/blob/main/Mini_proj2/img/optim_pred.png?raw=true',caption='최적의 파라미터 적용 그래프')
       st.subheader('RMSE 비교') 
